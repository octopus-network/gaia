...
func NewTestNetworkFixture() network.TestFixture {
	app := gaiaapp.NewGaiaApp(log.NewNopLogger(), dbm.NewMemDB(), nil, true, simtestutil.EmptyAppOptions{})
	...
	return network.TestFixture{
		...
		GenesisState:   gaiaapp.ModuleBasics.DefaultGenesis(app.AppCodec()),
